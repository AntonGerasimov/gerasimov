#На вход программы подается число в шестнадцатеричной системе счисления. Программа выводит его запись в двоичном представлении.
	.data
in:
	.string "%x" #%x is for hexadecimal numbers 
int:
	.space 4
out:
	.string "\n"
